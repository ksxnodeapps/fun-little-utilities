...
export abstract class EventedStreamCombination<
  ...
  StreamChunk,
  StreamError,
  Chunk extends ChunkCarrier<Stream, StreamChunk, StreamError> = ChunkCarrier<Stream, StreamChunk, StreamError>,
  Error extends ErrorCarrier<Stream, StreamError, StreamChunk> = ErrorCarrier<Stream, StreamError, StreamChunk>,
