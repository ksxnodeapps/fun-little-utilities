...
export namespace MethodCallInstance {
  ...
  export abstract class Base<Name extends MethodName = MethodName>
  implements MethodCall.Base {
    constructor (
  ...
  export namespace EventModifier {
    ...
    @rename
    export class Data<Chunk>
    extends bindEvent('data')<EventedStream.DataEventListener<Chunk>>
    implements MethodCall.EventModifier.Data<Chunk> {}

    @rename
    export class Error<Err>
    extends bindEvent('error')<EventedStream.ErrorEventListener<Err>>
    implements MethodCall.EventModifier.Error<Err> {}

    @rename
    export class Close
    extends bindEvent('close')<EventedStream.CloseEventListener>
